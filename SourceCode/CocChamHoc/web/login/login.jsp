                ...
                <div class="right_part">
                    ...
                    <form action="../login" method="POST" id="form-1">
                        ...
                        <div class="form-group">
                            <input id="email" name="email" value="user@gmail.com" type="text" placeholder="Email" class="form-control">
                            <span class="form-message"></span>
                        </div>
                        <div class="form-group">
                            <input id="password" name="password" value="12345678" type="password" placeholder="Password" class="form-control">
                            <span class="form-message"></span>
                        </div>
