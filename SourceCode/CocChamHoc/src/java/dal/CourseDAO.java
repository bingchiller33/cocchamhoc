...
public class CourseDAO extends MyDAO {
     ...
     * @param categoryId  The ID of the category to filter courses by. Set to -1 to
     *                    ignore this filter.
     ...
     */
    public List<Course> searchCourses(String searchQuery, int categoryId, int levelId, int durationInSeconds, int page,
     ...
     * @throws SQLException
     */
    public int searchCoursesCount(String searchQuery, int categoryId, int levelId, int duration)
            throws SQLException {
