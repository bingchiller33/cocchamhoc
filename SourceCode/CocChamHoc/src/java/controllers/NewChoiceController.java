 ...
 * @author Phuoc
 */
@WebServlet(name="NewChoiceController", urlPatterns={"/admin/create-choice"})
public class NewChoiceController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            int questionId = ParseUtils.parseIntWithDefault(request.getParameter("questionId"), -1);
            ...
            choiceDao.createDefaultChoice(questionId);
