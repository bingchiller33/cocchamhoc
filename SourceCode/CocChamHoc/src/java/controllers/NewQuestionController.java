 ...
 * @author Phuoc
 */
@WebServlet(name = "NewQuestionController", urlPatterns = {"/admin/create-question"})
public class NewQuestionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            QuestionCRUDDAO quesDAO = new QuestionCRUDDAO();
            quesDAO.createDefaultQuestion(examId);
